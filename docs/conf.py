...
# -*- coding: utf-8 -*-
#
# wavespectra documentation build configuration file, created by
...
MOCK_MODULES = ['wavespectra.specpart',]
...
release = wavespectra.__version__
...
htmlhelp_basename = 'wavespectradoc'
...
latex_documents = [
    (master_doc, 'wavespectra.tex', 'wavespectra Documentation',
...
man_pages = [
    (master_doc, 'wavespectra', 'wavespectra Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wavespectra', 'wavespectra Documentation',
     author, 'wavespectra', 'One line description of project.',
     'Miscellaneous'),
]
